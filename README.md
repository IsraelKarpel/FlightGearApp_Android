...
![settin image](https://github.com/IsraelKarpel/FlightGearApp_Android/blob/master/FlighrGearSimulator.png)
* Press Fly!

## about the application
The app will look like this:
![appview](https://github.com/IsraelKarpel/FlightGearApp_Android/blob/master/appView.png)
...
## basic uml
![uml](https://github.com/IsraelKarpel/FlightGearApp_Android/blob/master/UML3.png)
